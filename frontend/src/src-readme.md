...
## Purpose
Holds the React + TypeScript client application, Monet-themed styling primitives, shared components, and API bindings.
...
| `pages/` | Route-level components (Dashboard, Insights, Journal, Calendar, Projects, Nutrition, User). |
