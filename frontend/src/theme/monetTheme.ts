...
export const lightTheme = {
  ...
  colors: {
    ...
    overlay: 'rgba(30, 31, 46, 0.06)',
    overlayHover: 'rgba(30, 31, 46, 0.10)',
    overlayActive: 'rgba(30, 31, 46, 0.14)',
    surfaceRaised: 'rgba(30, 31, 46, 0.04)',
    surfaceInset: 'rgba(30, 31, 46, 0.08)',
    accent: palette.pond['200'],
    accentSubtle: 'rgba(126, 215, 196, 0.18)',
    danger: palette.ember['300'],
    dangerSubtle: 'rgba(242, 140, 60, 0.14)',
    success: palette.pond['300'],
    successSubtle: 'rgba(63, 155, 138, 0.14)',
    focusRing: palette.pond['200'],
    scrollThumb: 'rgba(30, 31, 46, 0.18)',
...
export const darkTheme = {
  ...
  colors: {
    ...
    dangerSubtle: 'rgba(255, 192, 117, 0.14)',
    success: palette.pond['100'],
    successSubtle: 'rgba(184, 240, 223, 0.14)',
    focusRing: palette.pond['200'],
    scrollThumb: 'rgba(246, 240, 232, 0.14)',
    scrollTrack: 'transparent'
  },
  chart: {
